...
This article details how to set up your own Ubuntu mail server using Postfix and Dovecot with virtual users and domains. I started this project on Ubuntu 12.04 LTS but the procedures apply to later versions as well. After this we'll add a webmail client (I'd suggest Roundcube, although you can use SquirrelMail) and an anti-spam solution (SpamAssassin). These articles are also available in my Github. 
